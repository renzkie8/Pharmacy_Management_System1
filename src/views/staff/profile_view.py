"""Staff profile and settings view."""
...
def StaffProfileView():
    """Staff profile and account settings."""
        ...
        ft.Container(
            content=ft.Row([
                ...
                ft.Column([
                    ...
                    txt_username_header,
                    ft.Container(
                        content=ft.Text("Staff", size=12, weight="bold", color="onPrimaryContainer"),
                        bgcolor="primaryContainer",
