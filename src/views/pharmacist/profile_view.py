"""Pharmacist profile and settings view."""
...
def PharmacistProfileView():
    """Pharmacist profile and account settings."""
        ...
        ft.Container(
            content=ft.Row([
                ...
                ft.Column([
                    ...
                    txt_username_header,
                    ft.Container(
                        content=ft.Text("Pharmacist", size=12, weight="bold", color="onPrimaryContainer"),
                        bgcolor="primaryContainer",
