...
2. **Azure SQL Database (In Progress)**: Provides persistent storage for user accounts and orders.
3. **Azure Storage / Redis (Planned)**: For static assets or session caching.
